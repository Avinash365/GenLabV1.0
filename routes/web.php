...
Route::get('/letters-explorer/{path?}', [BookingLetterController::class, 'showLetters'])->where('path', '.*');
Route::get('/booking/{id}/letter', [BookingLetterController::class, 'viewLetter'])->name('booking.letter');
