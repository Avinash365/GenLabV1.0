        ...
        <div class="card-body-custom">
            @if($verified)
                ...
                <div class="details-box">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">{{ $item->issue_date ? $item->issue_date->format('d/m/Y') : 'N/A' }}</span>
                    </div>
                    <div class="detail-row">
            ...
            @else
                ...
                <div class="alert alert-warning mt-4 small text-start">
                    <p class="mb-0">Please check the number and try again. If you believe this is an error, please contact the laboratory directly.</p>
                </div>
            @endif
