...
<div class="container">
    <div class="page-header">
        ...
        <ul class="table-top-head list-inline d-flex gap-3" >
            ...
            <li class="list-inline-item">
                <a href="{{ route('superadmin.vehicles.export.excel', request()->query()) }}" class="no-loader" data-bs-toggle="tooltip" title="Excel">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const actionTemplate = "{{ route('superadmin.vehicles.service.store', 0) }}"; // will replace 0
