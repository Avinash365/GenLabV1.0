                            ...
                            <div class="row mt-3">
                                <div class="col-sm-4 col-12">
                                    ...
                                    <input type="date" class="form-control" name="letter_date" 
                                        value="{{ old('letter_date', $booking->getRawOriginal('letter_date') ? substr($booking->getRawOriginal('letter_date'),0,10) : '') }}" 
                                        required>
                                </div>
                                <div class="col-sm-4 col-12">
                                    ...
                                    <input type="date" class="form-control" name="job_order_date" 
                                        value="{{ old('job_order_date', $booking->getRawOriginal('job_order_date') ? substr($booking->getRawOriginal('job_order_date'),0,10) : '') }}" 
                                        required>
                                </div>
                                <div class="col-sm-4 col-12">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-4 col-sm-6 col-12">
                                    ...
                                    <input type="text" class="form-control" name="contact_no" 
                                        value="{{ old('contact_no', $booking->contact_no) }}" >
                                </div>
                                    ...
                                    <div class="item-group border p-3 mb-3 rounded">
                                        <div class="row g-3">
                                            <div class="col-lg-4 col-sm-6 col-12">
                                                ...
                                                <input type="text" name="booking_items[{{ $index }}][sample_description]" class="form-control" value="{{ $item['sample_description'] ?? '' }}">
                                            </div>
                                            <div class="col-lg-4 col-sm-6 col-12">
                                            ...
                                            <div class="col-sm-3 col-12">
                                                <label class="form-label">Job Order Date <span class="text-danger">*</span></label>
                                                                <input 
                                                                    ...
                                                                    value="{{ !empty($item['job_order_date']) ? substr($item['job_order_date'], 0, 10) : '' }}"
                                            ...
                                            <div class="col-lg-2 col-sm-6 col-12">
                                                ...
                                                <input type="text" name="booking_items[{{ $index }}][amount]" class="form-control amount" value="{{ $item['amount'] ?? '' }}" required>
                                            </div>
                                            <div class="col-lg-2 col-sm-6 col-12">
                                            ...
                                            <div class="col-lg-4 col-sm-6 col-12 position-relative">
                                                ...
                                                <input type="text" class="form-control lab_analysis_input" autocomplete="off" value="{{ $item['lab_analysis_code'] ?? '' }}" required>
                                                <input type="hidden" name="booking_items[{{ $index }}][lab_analysis_code]" class="lab_analysis_code_hidden" value="{{ $item['lab_analysis_code'] ?? '' }}">
                                            ...
                                            <div class="col-lg-4 col-sm-6 col-12">
                                                ...
                                                <input type="date" name="booking_items[{{ $index }}][lab_expected_date]" class="form-control" 
                                                    value="{{ !empty($item['lab_expected_date']) ? substr($item['lab_expected_date'],0,10) : '' }}" required>
                                            </div>
                                             <div class="col-lg-4 col-sm-6 col-12">
