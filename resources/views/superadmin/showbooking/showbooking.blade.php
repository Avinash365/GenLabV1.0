        ...
        <div class="card">
            ...
            <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-2">
                ...
                <div class="search-set">
                    <form method="GET" action="{{ route('superadmin.showbooking.showBooking', $department?->id) }}"
            ...
            <div class="mb-4 mt-4 ms-3">
                <div class="d-flex flex-wrap gap-2">
                    <a href="{{ route('superadmin.showbooking.showBooking') }}{{ $query ? '?' . $query : '' }}"
                        class="btn btn-sm {{ !$department ? 'btn-primary' : 'btn-outline-primary' }}">
                        All
                    </a>
                    @foreach($departments as $dept)
                        <a href="{{ route('superadmin.showbooking.showBooking', $dept->id) }}{{ $query ? '?' . $query : '' }}"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Booking Items for {{ $booking->client_name }}
                                                            </h5>
