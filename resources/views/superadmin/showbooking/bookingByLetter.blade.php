    ...
    <div class="page-header">
        ...
        <ul class="table-top-head list-inline d-flex gap-3">
            <li class="list-inline-item">
                ...
                @endphp
                <a href="{{ route('superadmin.bookings.bookingByLetter.exportPdf') }}{{ $q ? ('?'.$q) : '' }}" class="no-loader" data-bs-toggle="tooltip" title="PDF"><div class="fa fa-file-pdf"></div></a>
            </li>
            <li class="list-inline-item">
                @php 
                    ...
                    $q = http_build_query($params); 
                @endphp
                <a href="{{ route('superadmin.bookings.bookingByLetter.exportExcel') }}{{ $q ? ('?'.$q) : '' }}" class="no-loader" data-bs-toggle="tooltip" title="Excel">
