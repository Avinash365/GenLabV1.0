    ...
    <div class="card mb-3">
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <form method="POST" action="#" id="upload-letters-form" class="d-flex gap-2 align-items-start flex-wrap" data-list-url="{{ $listRoute }}">
                        ...
                        <div class="d-flex gap-5 align-items-center">
                            ...
                            <button type="button" class="btn btn-outline-secondary" id="show-letter-btn" {{ empty($__singleLetter) ? 'disabled' : '' }}>Show Letter</button>
                            <a href="{{ $__singleInvoice ?? 'javascript:void(0)' }}"
                               target="_blank"
                               class="border rounded d-flex align-items-center justify-content-center p-2 text-decoration-none me-2 {{ $__singleInvoice ? '' : 'disabled text-muted' }}"
                               style="width:38px;height:38px;"
                               data-bs-toggle="tooltip"
                               title="{{ $__singleInvoice ? 'View Bill' : 'Bill not generated' }}"
                               {{ $__singleInvoice ? '' : 'aria-disabled="true"' }}>
                ...
                @endif
                {{-- invoice link rendered above; no hidden input needed --}}
            </div>
        </div>
    </div>
    @endif
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center mt-3">
                <div class="d-flex align-items-center gap-3">
                    <form id="perpage-form" method="GET" action="{{ route('superadmin.reporting.dispatch') }}" class="d-inline-flex align-items-center gap-2">
