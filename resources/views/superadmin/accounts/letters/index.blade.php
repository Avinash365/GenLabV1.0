    ...
    <div class="content">
        <div class="page-header">
            ...
            <ul class="table-top-head list-inline d-flex gap-2 ms-auto me-3 align-items-center">
                ...
                @endif
            <li class="list-inline-item">
                <a href="{{ route('superadmin.accountBookingsLetters.exportPdf') }}{{ $query ? ('?'.$query) : '' }}" class="no-loader" data-bs-toggle="tooltip" title="PDF"><div class="fa fa-file-pdf"></div></a>
            </li>
            <li class="list-inline-item">
                <a href="{{ route('superadmin.accountBookingsLetters.exportExcel') }}{{ $query ? ('?'.$query) : '' }}" class="no-loader" data-bs-toggle="tooltip" title="Excel">
