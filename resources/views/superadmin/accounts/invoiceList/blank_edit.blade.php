...
<div class="content">
    <form id="invoiceForm"
      method="POST"
      action="{{ route('superadmin.blank-invoices.update', $invoice->id) }}">
    @csrf
    @method('PUT')
       <input type="hidden" id="td_booking_id" value="{{ $invoice->booking_id }}">
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered mb-4">
                    <tr>
                        ...
                        <td contenteditable="true" class="editable" id="td_client_name">{{ $invoice->client_name }}</td>
                        <th style="width: 190px;">Marketing Person</th>
                        <td contenteditable="true" class="editable" id="td_marketing_person">{{ $invoice->marketing_person }}</td>
                    </tr>
                    <tr>
                        <th style="width: 190px;">Invoice No</th>
                        <td contenteditable="true" class="editable" id="td_invoice_no"> {{ $invoice->invoice_no }}</td>
                        <th>Reference No</th>
                        <td contenteditable="true" class="editable" id="td_reference_no">{{ $invoice->reference_no }}</td>
                    </tr>
                    <tr>
                        <th style="width: 190px;">Invoice Date</th>
                        <td contenteditable="true" class="editable" id="td_invoice_date">    {{ $invoice->invoice_date }}</td>
                        <th>Letter Date</th>
                        <td contenteditable="true" class="editable" id="td_letter_date">{{ $invoice->letter_date }}</td>
                    </tr>
                    <tr>
                        ...
                        <td contenteditable="true" class="editable" id="td_bill_issue_to">{{ $invoice->bill_issue_to }}</td>
                    </tr>
                    <tr>
                        ...
                        <td contenteditable="true" class="editable" id="td_address">{!! nl2br(e($invoice->address)) !!}</td>
                    </tr>
                </table>
...
<th id="payableAmount" class="text-right">{{ number_format($invoice->payable_amount, 2) }}</th>
       ...
       name="typeOption" value="tax_invoice"
       {{ $invoice->invoice_type === 'tax_invoice' ? 'checked' : '' }}>
                        <label class="form-check-label" for="typeInvoice">Tax Invoice</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio"
       name="typeOption" value="proforma_invoice"
       {{ $invoice->invoice_type === 'proforma_invoice' ? 'checked' : '' }}>
                ...
                <div class="d-flex justify-content-end">
                    <button type="submit" class="btn btn-success">
                        <i class="fa fa-file-pdf me-2"></i>Update
                    </button>
                </div>
