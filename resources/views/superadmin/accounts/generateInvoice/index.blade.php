                    ...
                    <div class="search-set ">
                        <form method="GET" class="d-flex input-group">
                            ...
                            <button class="btn btn-outline-secondary ms-2" type="submit"
                                formaction="{{ route('superadmin.bookingInvoiceStatuses.index', $department?->id) }}">🔍</button>
                        </form>
                    </div>

                    <!-- Marketing Person, Client, Month & Year Filter Form -->
                    <div class="search-set">
                        <form method="GET" action="{{ route('superadmin.bookingInvoiceStatuses.index', $department?->id) }}"
                            class="d-flex gap-2">
