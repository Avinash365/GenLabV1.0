    ...
    <div class="page-header">
        ...
        <ul class="table-top-head list-inline d-flex gap-3">
            <li class="list-inline-item">
                <a href="{{ route('superadmin.bookingInvoiceStatuses.exportPdf', request()->query()) }}" class="no-loader" data-bs-toggle="tooltip" title="PDF"><div class="fa fa-file-pdf"></div></a>
            </li>
            <li class="list-inline-item">
                <a href="{{ route('superadmin.bookingInvoiceStatuses.exportExcel', request()->query()) }}" class="no-loader" data-bs-toggle="tooltip" title="Excel">
            ...
            <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-2">
                ...
                <div class="search-set ">
                    <form method="GET"  class="d-flex input-group">
                        ...
                        <button class="btn btn-outline-secondary " type="submit" formaction="{{ route('superadmin.bookingInvoiceStatuses.index', $department?->id) }}">🔍</button>
                    </form>
                </div>
