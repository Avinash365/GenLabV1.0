...
<div class="header" style="background:#fff; border-bottom:1px solid #e5e7eb; padding:0;">
    ...
    <div class="dropdown mobile-user-menu">
        ...
        <div class="dropdown-menu dropdown-menu-end">
            ...
            <a href="<?php echo e(route('chat.index')); ?>" class="btn btn-light d-flex align-items-center justify-content-center p-0 position-relative chat-toggle-btn" style="border-radius:8px; width:30px; height:30px; border:1px solid #e5e7eb; background:#fff;">
                <i class=""></i>
   ...
   <div class="container-fluid d-flex align-items-center justify-content-between d-none d-lg-flex" style="min-height:56px; padding:15px 20px 12px; gap:0;">
        ...
        <div class="d-flex align-items-center flex-grow-1" style="gap:30px; min-width:0;">
            <form class="d-flex align-items-center flex-shrink-0" method="GET" action="<?php echo e(route('job-order.search')); ?>" style="width:300px;">
