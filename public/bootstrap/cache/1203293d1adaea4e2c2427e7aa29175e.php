...
(function(){
    ...
    ?>
    const currentUser = { id: <?php echo e($authUser ? (int)$authUser->id : 'null'); ?>, name: <?php echo json_encode($authUser->name ?? 'Guest', 15, 512) ?>, avatar: <?php echo json_encode($chatAvatarUrl ?? null, 15, 512) ?> };
