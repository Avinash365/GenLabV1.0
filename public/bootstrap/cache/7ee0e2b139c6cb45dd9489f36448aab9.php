        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-5">
                    ...
                    <form method="POST" action="<?php echo e($uploadRoute); ?>" enctype="multipart/form-data" id="upload-letters-form" class="d-flex gap-2 align-items-start flex-wrap" data-list-url="<?php echo e($listRoute); ?>" data-letters-upload-form="1">
                        <?php echo csrf_field(); ?>
                ...
                <div class="col-md-4">
                    ...
                    <form method="POST" action="<?php echo e($uploadRoute); ?>" enctype="multipart/form-data" id="upload-docs-form" class="d-flex gap-2 align-items-start flex-wrap" data-letters-upload-form="1">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="job" value="<?php echo e($letterKey); ?>">
