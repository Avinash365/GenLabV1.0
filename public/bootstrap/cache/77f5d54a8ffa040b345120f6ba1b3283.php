...
<?php if(isset($item)): ?>
    ...
    <div class="page">
        <div class="card">
            ...
            <div class="table">
                <div class="lr-no">Job Order No :-  <span class="value1"><?php echo e($item->job_order_no); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($item->sample_code ?? ''); ?> </span>
    ...
    <?php $__currentLoopData = $booking->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="page" <?php if($key < $booking->items->count()-1): ?> style="page-break-after: always;" <?php endif; ?>>
            <div class="card">
                ...
                <div class="table">
                    <div class="lr-no">Job Order No :- <span class="value1"><?php echo e($it->job_order_no); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($it->sample_code ?? ''); ?></span> 
