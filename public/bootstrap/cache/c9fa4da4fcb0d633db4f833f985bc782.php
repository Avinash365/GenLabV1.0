...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        ...
        <div class="a4-page">
            ...
            <form id="previewInvoiceForm" method="POST" action="<?php echo e($ACTION_URL ?? 'superadmin.bookingInvoiceStatuses.storeBulk'); ?>">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="3" contenteditable="false" id="td_reference_block">
                                    <?php echo e($allReferences ?? ''); ?>

                                    &nbsp;&&nbsp;
                                    <?php echo e($allLetterDates ?? ''); ?>
                ...
                <div class="card-body invoice-settings-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="btn btn-sm btn-outline-primary w-100 text-start" id="td_marketing_person">
                            <?php echo e($bookings->first()->marketingPerson->name ?? '-'); ?>
                            ...
                            <div class="card-body p-4">
                                ...
                                <form id="gstinUploadForm" enctype="multipart/form-data" method="POST"
                                    ...
                                    <input type="hidden" name="invoice_id"
                                        value="<?php echo e($bookings->first()->generatedInvoice?->id ?? '0'); ?>">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                        ...
                                        <div class="d-flex gap-2">
                                            ...
                                            <!-- View Button -->
                                            <a href="<?php echo e($bookings->first()->generatedInvoice?->invoice_letter_path
        ? url($bookings->first()->generatedInvoice->invoice_letter_path)
        : '#'); ?>" target="_blank" class="btn btn-outline-secondary btn-sm
                                                                                                        <?php echo e(empty($bookings->first()->generatedInvoice?->invoice_letter_path) ? 'disabled' : ''); ?>">
               ...
               e.preventDefault(); 
                ...
                let invoiceData = {
                    ...
                    booking_info: {
                        ...
                        client_name: "<?php echo e($bookings->first()->client->name ?? ''); ?>",
                        marketing_person: "<?php echo e($bookings->first()->marketingPerson->name ?? ''); ?>",
                        ...
                        client_gstin: billing.client_gstin || "<?php echo e($bookings->first()->gstin ?? ''); ?>",
