        ...
        <div class="page-header">
            ...
            <ul class="table-top-head list-inline d-flex gap-3">
                <li class="list-inline-item">
                    <a href="<?php echo e(route('superadmin.showbooking.exportPdf', array_filter(['department' => $department?->id, 'search' => request('search'), 'month' => request('month'), 'year' => request('year')], fn($v) => filled($v)))); ?>"
                        data-bs-toggle="tooltip" title="PDF">
                        <div class="fa fa-file-pdf"></div>
                    </a>
                </li>
                <li class="list-inline-item">
                    <a href="<?php echo e(route('superadmin.showbooking.exportExcel', array_filter(['department' => $department?->id, 'search' => request('search'), 'month' => request('month'), 'year' => request('year')], fn($v) => filled($v)))); ?>"
        ...
        <div class="card">
            ...
            <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-2">
                ...
                <div class="search-set">
                    <form method="GET" action="<?php echo e(route('superadmin.showbooking.showBooking', $department?->id)); ?>"
            ...
            <?php
                $query = http_build_query(
                    array_filter(request()->only(['search', 'month', 'year']))
                );
            ?>
            ...
            <div class="mb-4 mt-4 ms-3">
                <div class="d-flex flex-wrap gap-2">
                    <a href="<?php echo e(route('superadmin.showbooking.showBooking')); ?><?php echo e($query ? '?' . $query : ''); ?>"
                        class="btn btn-sm <?php echo e(!$department ? 'btn-primary' : 'btn-outline-primary'); ?>">
                        All
                    </a>
                    <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('superadmin.showbooking.showBooking', $dept->id)); ?><?php echo e($query ? '?' . $query : ''); ?>"
                ...
                <div class="table-responsive">
                    <table class="table">
                        <thead class="table-light">
                            <tr>
                                <th><label class="checkboxs"><input type="checkbox" id="select-all"><span
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                >
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Booking Items for <?php echo e($booking->client_name); ?>
                                    ...
                                    <td class="d-flex">
                                        ...
                                        <!-- View Booking Card -->
                                        <a href="<?php echo e(route('superadmin.bookings.cards.all', [$booking->id])); ?>" target="_blank"
                        ...
                        <form method="GET" action="<?php echo e(route('superadmin.showbooking.showBooking', $department?->id)); ?>"
                            ...
                            <select name="perPage" id="perPageSelect" class="form-select form-select-sm w-auto"
                                ...
                                <?php $__currentLoopData = [25, 50, 100]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($size); ?>" <?php echo e(request('perPage', 25) == $size ? 'selected' : ''); ?>><?php echo e($size); ?>
