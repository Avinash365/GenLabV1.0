        ...
        <ul class="table-top-head list-inline d-flex gap-3">
            <li class="list-inline-item">
                <?php
                    ...
                    $exportLimit = 1000;
                ?>
                <a href="<?php echo e(route('superadmin.showbooking.exportPdf')); ?><?php echo e($exportQ ? ('?'.$exportQ) : ''); ?>" class="no-loader export-link export-pdf" data-bs-toggle="tooltip" title="PDF" data-total="<?php echo e($totalItems); ?>" data-has-filters="<?php echo e(count($exportParams) ? 1 : 0); ?>" data-limit="<?php echo e($exportLimit); ?>"><div class="fa fa-file-pdf"></div></a>
            </li>
            <li class="list-inline-item">
                <a href="<?php echo e(route('superadmin.showbooking.exportExcel')); ?><?php echo e($exportQ ? ('?'.$exportQ) : ''); ?>" class="no-loader export-link export-excel" data-bs-toggle="tooltip" title="Excel" data-total="<?php echo e($totalItems); ?>" data-has-filters="<?php echo e(count($exportParams) ? 1 : 0); ?>" data-limit="<?php echo e($exportLimit); ?>">
    ...
    <div class="search-set">
        ...
        <div class="mb-4 mt-4 ms-3">
            <div class="d-flex flex-wrap gap-2 align-items-center">
                <a href="<?php echo e(route('superadmin.showbooking.showBooking', array_filter(['search' => request('search'), 'month' => request('month'), 'year' => request('year'), 'marketing' => request('marketing'), 'use_created_at' => request('use_created_at')], fn($v) => filled($v)))); ?>"
                   class="btn btn-sm <?php echo e(!$department ? 'btn-primary' : 'btn-outline-primary'); ?>">
                    All
                </a>

                <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('superadmin.showbooking.showBooking', array_filter(['department' => $dept->id, 'search' => request('search'), 'month' => request('month'), 'year' => request('year'), 'marketing' => request('marketing'), 'use_created_at' => request('use_created_at')], fn($v) => filled($v)))); ?>"
                ...
                <?php if(isset($marketingPersons) && $marketingPersons->count()): ?>
                    <form method="GET" action="<?php echo e(route('superadmin.showbooking.showBooking', $department?->id)); ?>" class="ms-auto me-3 d-flex align-items-center">
                        <?php if(request('search')): ?><input type="hidden" name="search" value="<?php echo e(request('search')); ?>"><?php endif; ?>
                        ...
                        <tr class="table-row">
                            ...
                            <td class="action-col">
                                <div class="d-flex justify-content-end align-items-center">
                                    ...
                                    <!-- Delete Button -->
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('booking.delete', $booking)): ?>
...
<?php echo $__env->make('superadmin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH A:\GenTech\htdocs\GenlabV3.0\GenLabV3.0\resources\views/superadmin/showbooking/showbooking.blade.php ENDPATH**/ ?>