...
<div class="content">
                ...
                <div class="card h-100 employee-card">
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mt-auto d-flex justify-content-between align-items-center">
                            ...
                            ?>
                            <span class="badge rounded-pill bg-<?php echo e($badgeColor); ?> bg-opacity-10 text-<?php echo e($textColor); ?> text-capitalize">
    ...
    <div class="mt-4">
        <?php if(method_exists($employees, 'links')): ?>
            <?php echo $employees->withQueryString()->links('pagination::bootstrap-5'); ?>
...
<?php echo $__env->make('superadmin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Mamp\htdocs\GenLabV2.0\resources\views/superadmin/employees/index.blade.php ENDPATH**/ ?>