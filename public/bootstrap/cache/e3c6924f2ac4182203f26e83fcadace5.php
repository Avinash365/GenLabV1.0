<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex gap-3">
        ...
        <div class="form-check">
            <input class="form-check-input"
                   ...
                   id="header_1"
                   value="1">
            <label class="form-check-label" for="header_1">
                Include Header 1
            </label>
        </div>
        ...
        <div class="form-check">
            <input class="form-check-input"
                   ...
                   id="header_2"
                   value="2">
            <label class="form-check-label" for="header_2">
                Include Header 2
            </label>
        </div>
    ...
    <div id="floatingPdfView" style="display:none; position: fixed; top: 80px; left: 100px; width: 600px; height: 650px; 
        ...
        <div id="pdfHeader" style="background-color: #007bff; color: #fff; padding: 8px 12px; 
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function updatePdfPreview() {
                ...
                const selectedHeader = document.querySelector(
                    'input[name="include_header"]:checked'
                )?.value || 0;
