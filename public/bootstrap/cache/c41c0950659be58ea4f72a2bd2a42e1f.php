                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="status-cell" data-id="<?php echo e($item->id); ?>">
                                    ...
                                    <?php if($item->latestMarketingEnquiry): ?>
                                        <button type="button" class="btn btn-sm btn-success py-0 ms-2 lh-1 text-white enquiry-btn" 
                                            data-id="<?php echo e($item->id); ?>" 
                                            data-note="<?php echo e($item->latestMarketingEnquiry->note); ?>"
                                            data-media="<?php echo e(json_encode($item->latestMarketingEnquiry->media_paths)); ?>"
                                            data-created-at="<?php echo e($item->latestMarketingEnquiry->created_at->format('d/m/Y h:i A')); ?>"
                ...
                try {
                    ...
                    if (mediaPaths && mediaPaths.length > 0) {
                        ...
                        mediaPaths.forEach(function(item) {
                            ...
                            const url = "<?php echo e(asset('storage')); ?>/" + path;
