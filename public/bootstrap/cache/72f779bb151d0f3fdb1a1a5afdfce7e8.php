    ...
    <div class="page-header">
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                        ...
                        <tbody>
                            ...
                            <tr   <?php if($isPaid): ?> class="table-success" <?php endif; ?>>
                                ...
                                <td class="d-flex align-items-center gap-2">
                                    ...
                                    <?php if($user && ($user instanceof Admin || $user->hasPermission('cash_letter.edit'))): ?>
                                        <!-- Move / Transfer -->
                                        <a href="#" 
             ...
             <?php if($user && ($user instanceof Admin || ($user->hasPermission('cash_payment.create')))): ?>
                <div class="p-3">
...
<?php echo $__env->make('superadmin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH A:\GenTech\htdocs\GenlabV3.0\GenLabV3.0\resources\views/superadmin/accounts/cashLetter/index.blade.php ENDPATH**/ ?>