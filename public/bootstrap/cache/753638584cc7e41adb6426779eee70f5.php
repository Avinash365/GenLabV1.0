                            ...
                            <div class="row g-3">
                                <div class="col-4">
                                    <div class="text-center p-2 border rounded small">
                                        ...
                                        <div class="fw-bold" id="statSales"><?php echo e(number_format($salesGst ?? 0, 2)); ?></div>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="text-center p-2 border rounded small">
                                        <div class="text-muted">Purchase</div>
                                        <div class="fw-bold" id="statPurchase"><?php echo e(number_format($purchaseGst ?? 0, 2)); ?></div>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="text-center p-2 border rounded small">
                                        <div class="text-muted">Total</div>
                                        <div class="fw-bold" id="statTotal"><?php echo e(number_format($totalGst ?? 0, 2)); ?></div>
                                    </div>
                                </div>
                            </div>
                            <script>
